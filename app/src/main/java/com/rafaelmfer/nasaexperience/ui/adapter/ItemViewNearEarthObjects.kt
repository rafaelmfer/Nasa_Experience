...
class ItemViewNearEarthObjects : ItemViewBuilderViewBinding<CelestialObjects, ItemAsteroidsBinding>() {
    ...
    override fun ItemAsteroidsBinding.onBind(position: Int) {
        collection.get(position).run {
            ...
            dateSeenObject.text = closeApproachData[0].closeApproachDateFull.formatFromServer(
